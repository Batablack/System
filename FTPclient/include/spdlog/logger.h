...
// Thread safe magicLogger (except for set_error_handler())
// Has name, log level, vector of std::shared sink pointers and formatter
// Upon each log write the magicLogger:
...
#    define SPDLOG_LOGGER_CATCH(location)                                                                                                  \
        ...
        {                                                                                                                                  \
            err_handler_("Rethrowing unknown exception in magicLogger");                                                                        \
            throw;                                                                                                                         \
        }
#else
#    define SPDLOG_LOGGER_CATCH(location)
...
public:
    ...
    // set formatting for the sinks in this magicLogger.
    ...
    // create new magicLogger with same sinks and configuration.
